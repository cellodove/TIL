# [Android] RecyclerView - List Adapter
...
![fragmentlistadapter.PNG](/img/android/recyclerview/fragmentlistadapter.png?raw=true)
...
![listadapterresult.png](/img/android/recyclerview/listadapterresult.png?raw=true)
