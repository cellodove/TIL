...
![handler1.png](/img/android/handler/handler1.png?raw=true)
...
![handler2.png](/img/android/handler/handler2.png?raw=true)

### Handler와 Looper의 동작과정

![handler3.png](/img/android/handler/handler3.png?raw=true)
